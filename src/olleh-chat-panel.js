...
function initChatPanel() {
  ...
  function injectStyles() {
    ...
    styleEl.textContent = [
      ...
      '  gap: 16px;',
      '}',
      '.olleh-cp-input-wrap { flex: 1; min-width: 0; }',
      '.olleh-cp-input {',
      '  width: 100%;',
      '  border: 1px solid var(--olleh-cp-mist);',
      '  outline: none;',
      ...
      '  border-color: var(--olleh-cp-primary);',
      '  box-shadow: 0 0 0 3px rgba(108, 0, 52, 0.12);',
      '}',
      '.olleh-cp-input::placeholder { color: #897176; }',
      '.olleh-cp-input:disabled { opacity: 0.6; cursor: not-allowed; }',
      '.olleh-cp-send {',
      '  flex-shrink: 0;',
      '  width: 52px;',
      '  height: 52px;',
      '  border: none;',
      '  border-radius: 9999px;',
      '  background: linear-gradient(180deg, var(--olleh-cp-gradient-start) 0%, var(--olleh-cp-gradient-end) 100%);',
      '  color: #fff;',
      '  display: inline-flex;',
      '  align-items: center;',
      ...
      '  cursor: pointer;',
      '  padding: 0;',
      '  box-shadow: 0 10px 20px rgba(84, 16, 46, 0.25);',
      '  transition: transform 0.1s ease, opacity 0.15s ease;',
      '}',
      '.olleh-cp-send:active:not(:disabled) { transform: scale(0.95); }',
      '.olleh-cp-send:disabled { opacity: 0.5; cursor: not-allowed; }',
      '.olleh-cp-send svg { width: 22px; height: 22px; }',
